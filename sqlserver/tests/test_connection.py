...
@pytest.mark.parametrize(
    ...
    [
        pytest.param('1.2.3.4', 22, '1.2.3.4,22', id='if port provided as a config option as an int, it should be recognized'),
        pytest.param('1.2.3.4', 22, '1.2.3.4,22', id='if port provided as a config option as a string, it should be recognized'),
